...
const QuestShop = () => {
  ...
  const {coinsQuantity, setSelectedCubFromShop, setCoinsQuantity} = useStore();

  const shop = [
    {
      image: require('../../assets/images/joker100.png'),
      price: '100',
    },
    {
      image: require('../../assets/images/joker500.png'),
      price: '500',
    },
    {
      image: require('../../assets/images/joker500.2.png'),
      price: '500',
    },
  ];
  ...
  const handleBuyJoker = () => {
    if (currentCubIdx === 0 && coinsQuantity >= 100) {
      ...
      setCoinsQuantity(coinsQuantity - 100);
    } else if (currentCubIdx === 1 && coinsQuantity >= 500) {
      setSelectedCubFromShop(currentCubIdx + 1);
    } else if (currentCubIdx === 2 && coinsQuantity >= 500) {
      setSelectedCubFromShop(currentCubIdx + 1);
    }
  };
          ...
          <View style={styles.mainContainer}>
            <View style={styles.nestedContainer}>
              <View
                ...
                <Image
                  source={shop[currentCubIdx].image}
